...
Source: https://kb.kentik.com/docs

---

Welcome to Kentik’s swanky new knowledge base (KB)! The following sections explain the new format and navigation of the Kentik KB. You’ll encounter three different page formats: landing page, an article view, and the advanced search.
...
![Search term input field with related articles and categories displayed below.](https://cdn.us.document360.io/082e25b5-afce-42d4-8f47-70bd3f1d02b7/Images/Documentation/UKB-search(1).png?sv=2022-11-02&spr=https&st=2026-05-12T09%3A15%3A39Z&se=2026-05-12T09%3A32%3A39Z&sr=c&sp=r&sig=nh7CRetiz%2BAUCjpVysB63HxxyyugFGPuCOmBDzt1EBU%3D)
...
The content of an article is displayed in the center of the screen. The following elements display within, above, or below the article’s content:
...
* **Time to read**: An approximate time (in minutes) that it takes an average user to read that article. ![](https://cdn.us.document360.io/082e25b5-afce-42d4-8f47-70bd3f1d02b7/Images/Documentation/Screenshot 2025-09-15 at 6.38.12 PM.png?sv=2022-11-02&spr=https&st=2026-05-12T09%3A15%3A39Z&se=2026-05-12T09%3A32%3A39Z&sr=c&sp=r&sig=nh7CRetiz%2BAUCjpVysB63HxxyyugFGPuCOmBDzt1EBU%3D)
* **Listen**: Listen to the article read aloud and control the audio using a pop-up player displayed in the lower right corner of your screen. Jump back or forward by 10 seconds, pause, play, or use the scrub (progress) bar to move to any point in the article.

  + Any links included in the text will be preceded by the words “a link” and followed by “is provided here.”
  + Table data is not read.
...
* **Orange text**: Indicates an element of the portal’s UI (e.g., a button, table, or panel).
  ...
  > **Note**: Some articles still feature grey text for UI elements. These will be updated as we update the articles’ content.
* **Feedback**: **Yes** and **No** buttons for you to provide feedback on whether the article was helpful or not. Click either button to display a popup where you can provide a comment or opt to be notified when that article is updated.
* **Previous/Next article**: Allows you to navigate to the previous or next article in the KB (as presented in the **Explore articles sidebar**).
* **Related articles**: A list of three article links that are related to the article currently displayed. The path to navigate to each article is displayed below it.
